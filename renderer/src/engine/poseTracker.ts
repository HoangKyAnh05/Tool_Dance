...
export class PoseTracker {
  ...
  private rawAILandmarks: Landmark[] | null = null;
  private isProcessingAI = false;
  private mpPose: any = null;
  public aiReady = false;

  // Multi-Dancer Lock Target
  private lockedTargetX: number = 0.5;
  private lockedDancerLabel = 'Vũ Công Trung Tâm (Gần Nhất)';
  ...
  public static readonly NOSE = 0;
  public static readonly LEFT_EYE = 2;
  public static readonly RIGHT_EYE = 5;
  public static readonly LEFT_EAR = 7;
  public static readonly RIGHT_EAR = 8;
  public static readonly LEFT_SHOULDER = 11;
  public static readonly RIGHT_SHOULDER = 12;
  public static readonly LEFT_ELBOW = 13;
  public static readonly RIGHT_ELBOW = 14;
  public static readonly LEFT_WRIST = 15;
  public static readonly RIGHT_WRIST = 16;
  public static readonly LEFT_PINKY = 17;
  public static readonly RIGHT_PINKY = 18;
  public static readonly LEFT_INDEX = 19;
  public static readonly RIGHT_INDEX = 20;
  public static readonly LEFT_THUMB = 21;
  public static readonly RIGHT_THUMB = 22;
  public static readonly LEFT_HIP = 23;
  public static readonly RIGHT_HIP = 24;
  public static readonly LEFT_KNEE = 25;
  public static readonly RIGHT_KNEE = 26;
  public static readonly LEFT_ANKLE = 27;
  public static readonly RIGHT_ANKLE = 28;
  ...
  private initMediaPipePose() {
    try {
      ...
      if (typeof PoseClass !== 'undefined') {
        ...
        this.mpPose.onResults((results: any) => {
  ...
  public setElements(video: HTMLVideoElement, overlayCanvas: HTMLCanvasElement) {
    this.videoEl = video;
  ...
  public setLockTarget(normX: number, normY: number) {
  ...
  public getLockedDancerLabel(): string {
    return this.lockedDancerLabel;
  }

  private handleAIResults(landmarks: Array<{ x: number; y: number; z: number; visibility?: number }>) {
   ...
   */
  public processFrame(currentTime: number, beatFactor: number = 0): PoseFrameData {
    ...
    const raw: Landmark[] = [...this.smoothLandmarks];
   ...
   */
  public drawSkeleton(landmarks: Landmark[]) {
    ...
    const mapX = (normX: number) => offsetX + normX * renderW;
    const mapY = (normY: number) => offsetY + normY * renderH;
