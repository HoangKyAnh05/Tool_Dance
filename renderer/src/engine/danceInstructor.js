...
export class DanceInstructor {
    ...
    currentMoveName = 'Tư thế sẵn sàng & đón nhịp';
    currentLeftArmDesc = 'Thả lỏng cánh tay trái buông dọc thân người.';
    currentRightArmDesc = 'Thả lỏng cánh tay phải buông dọc thân người.';
    currentTorsoDesc = 'Giữ thẳng lưng, mắt nhìn thẳng về phía trước.';
    currentLeftLegDesc = 'Chân trái làm trụ đứng thẳng, tiếp đất vững vàng.';
    currentRightLegDesc = 'Chân phải đứng thẳng, bàn chân hướng ra trước.';
    candidateMoveName = '';
    candidateLeftArm = '';
    candidateRightArm = '';
    candidateTorso = '';
     ...
     */
    analyzeCurrentPose(landmarks, currentTime, duration) {
        ...
        const quantize = (deg) => Math.round(deg / 5) * 5;
        return {
            timeSec: currentTime,
            beatIndex,
            moveName: this.currentMoveName,
    ...
    generateFullTimeline(durationSec) {
        const list = [];
...
//# sourceMappingURL=danceInstructor.js.map